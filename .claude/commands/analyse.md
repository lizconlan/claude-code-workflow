...
Adopt the Business Analyst role described above completely.
...
1. Output: "Clearing analyst context — switching to Architect role..."
2. Discard all analyst context entirely
3. Read `.roles/ARCHITECT.md` using your file reading tool
4. Fully adopt the Solutions Architect role described in that file

Then output this message exactly:

> **Architect role loaded.** I have reviewed `REQUIREMENTS.md` and am ready to create the technical specification. Type `GO` to begin, or ask questions first.
